...
<div class="wrapper d-flex align-items-stretch">
    ...
    ?>
    <h2 class="mb-4"><em>Tambah Data Karyawan</em></h2>
...
<main>
      <div class="table-responsive large">
        <table class="table table-striped table-sm">
          <!--start 4 tabelhead-->
		<form method="post" action="../sistem/create_kar.php">
			<table>
        <!--edit here-->
        <div class="aa">
          <tr>
        ...
        <div class="aa">
          ...
          <div class="col-sm-10">
          <td><input type="text" class="form-control" value="MSI-" disabled style="width:18%;"></td>
          <td>
            <input type="text" class="form-control" name="nik" required style="width:100%; margin-left:-100%;" maxlength="5">
          </td>
          </div>
          </tr>
        </div>
        <div class="aa">
          ...
          <div class="col-sm-10">
          <td>
            <input type="radio" name="jenis_kelamin" id="" value="Laki-laki" required> Laki-laki
            <input type="radio" name="jenis_kelamin" id="" value="Perempuan" required> Perempuan
          </td>
          </div>
          </tr>
        </div>
        <div class="aa">
          ...
          <div class="col-sm-10">
          <td><textarea class="form-control" name="alamat" id="" cols="30" rows="3" required></textarea></td>
          </div>
          </tr>
        </div>
        <div class="aa">
        ...
        <div class="aa">
          ...
          <div class="col-sm-10">
          <td><select name="divisi" class="form-select" aria-label="Default select example"  required>
            ...
            while($data = mysqli_fetch_array($query)){
              echo "<option value=$data[nama_divisi]>$data[nama_divisi]</option>";
            }
            ?>
          </select></td>
          </div>
        ...
        <div class="aa">
          ...
          <div class="col-sm-10">
          <td><input type="text" class="form-control" value="Rp. " disabled style="width:18%;"></td>
          <td><input type="text" class="form-control" name="gaji" required style="width:100%; margin-left:-100%;"></td>
          </div>
          </tr>
        </div>
        <div class="aa">
